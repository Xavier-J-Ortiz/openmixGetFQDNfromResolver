var handler = new OpenmixApplication({
	...
	default_settings: {
		...
		sonar_availability_threshold: 0,
		min_rtt: 1,
		rtt_tp_mix: 0.15 // Set to 0 for pure Latency (RTT) routing.  Set to 1 for pure Throughput (kbps) routing.  And set between 0 and 1 for a blend of the two.
	},
	geo_settings: {
		state: {},
		region: {},
